  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Monitor and communicate with your students</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card className="p-6">
          <div className="space-y-2">
            ...
            <p className="text-3xl font-bold">{students.filter((s) => s.progress < 50).length}</p>
          </div>
        </Card>
      </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                  <div className="flex items-center gap-3 flex-1">
                    <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
                      <span className="text-lg font-medium text-primary">{student.name.charAt(0)}</span>
                    </div>
