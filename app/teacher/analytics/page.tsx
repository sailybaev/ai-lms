  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Detailed insights into course performance</p>
      </div>
        ...
        <Card className="p-6">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Student completion over time</p>
            </div>
        ...
        <Card className="p-6">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Views vs completion by lesson</p>
            </div>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={engagementData}>
                <CartesianGrid strokeDasharray="3 3" stroke="hsl(var(--border))" />
                <XAxis dataKey="lesson" stroke="hsl(var(--muted-foreground))" fontSize={12} />
                <YAxis stroke="hsl(var(--muted-foreground))" fontSize={12} />
                <Tooltip
                  contentStyle={{
                    backgroundColor: "hsl(var(--popover))",
                ...
                <Bar dataKey="completion" fill="hsl(var(--chart-2))" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Lessons needing attention</p>
            </div>
            <div className="space-y-3">
              <div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <p className="font-medium text-yellow-500">Project Module</p>
                    <p className="text-sm text-muted-foreground mt-1">Only 52% completion rate</p>
                  </div>
                  <span className="text-2xl font-bold text-yellow-500">52%</span>
                </div>
              </div>
              <div className="p-4 rounded-lg bg-orange-500/10 border border-orange-500/20">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    <p className="font-medium text-orange-500">Practice Exercises</p>
                    <p className="text-sm text-muted-foreground mt-1">68% completion, below average</p>
                  </div>
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                <div className="flex items-start justify-between gap-2">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">High dropout rate at 75%</p>
                  </div>
