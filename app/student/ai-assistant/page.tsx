...
import { Sparkles, Send, BookOpen, HelpCircle, Lightbulb } from "lucide-react"
  ...
  return (
    <div className="space-y-6 h-[calc(100vh-12rem)]">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Get instant help with your studies</p>
      </div>

      <div className="grid gap-4 h-full" style={{ gridTemplateRows: "auto 1fr auto" }}>
        {/* Suggestions */}
        {messages.length === 1 && (
