...
const achievements = [
  { title: "First Course Completed", description: "Completed your first course", date: "2025-01-10", earned: true },
  { title: "Week Warrior", description: "Studied 7 days in a row", date: "2025-01-12", earned: true },
  { title: "Perfect Score", description: "Got 100% on an assignment", date: "Not yet", earned: false },
  { title: "Course Master", description: "Complete 5 courses", date: "Not yet", earned: false },
]
        ...
        <Card className="p-6">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Your study time over the past month</p>
            </div>
        ...
        <Card className="p-6">
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Completion status by course</p>
            </div>
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={courseProgress}>
                ...
                />
                <Bar dataKey="progress" fill="hsl(var(--chart-2))" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </Card>
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {achievements.map((achievement, index) => (
              <Card
                key={index}
                className={`p-4 ${achievement.earned ? "border-primary/50 bg-primary/5" : "opacity-60"}`}
              >
                <div className="flex items-start gap-4">
                  ...
                  >
                    <Award className={`w-6 h-6 ${achievement.earned ? "text-primary" : "text-muted-foreground"}`} />
                  </div>
