...
import { AlertTriangle, FileText, Sparkles, TrendingUp } from 'lucide-react'
		...
		<div className='space-y-6'>
			<div>
				...
				<p className='text-muted-foreground mt-1'>
					Leverage AI to gain insights and automate tasks
				</p>
			</div>
					...
					<div className='flex items-start gap-4'>
						...
						<div className='flex-1'>
							...
							<p className='text-sm text-muted-foreground mt-1'>
								Create AI-generated insights on platform performance and user
								behavior
							</p>
						</div>
					</div>
				...
				<Card className='p-6 space-y-4'>
					<div className='flex items-start gap-4'>
						...
						<div className='flex-1'>
							...
							<p className='text-sm text-muted-foreground mt-1'>
								Identify unusual activity patterns, low engagement, or inactive
								users
							</p>
						</div>
					</div>
				...
				<div className='space-y-4'>
					...
					<div className='space-y-3'>
						{[
							...
							{
								action: 'Anomaly detected: Low weekend activity',
								time: '5 hours ago',
								type: 'warning',
							},
							{
								action: 'User engagement analysis completed',
								time: '1 day ago',
								type: 'success',
							},
							{
								action: 'Course recommendation model updated',
								time: '2 days ago',
								type: 'info',
							},
						].map((activity, index) => (
